...
void error_handler(const void* arg, ErrorType type) {
    printf("\nError ID: %s\n", ErrorNames[type]);
    ...
    case DATA_TYPE:
        ...
        printf("          Expected format: color color color ...\n");
    ...
    case INVALID_VERTEX:
        printf("          Invalid value of vertices.\n");
        break;

    case INVALID_COLOR:
        printf("          Invalid color on rectangle #%d\n", *((int*)arg));
        break;
